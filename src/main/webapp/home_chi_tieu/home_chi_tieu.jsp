...
<link rel="stylesheet"
	href="/QuanLyChiTieu/home_chi_tieu/home_chi_tieu.css" />
<!-- Unicons -->
<link rel="stylesheet"
	href="/QuanLyChiTieu/fontawesome-free-6.5.1-web/css/fontawesome.css">
<link rel="stylesheet"
	href="/QuanLyChiTieu/fontawesome-free-6.5.1-web/css/brands.css">
<link rel="stylesheet"
	href="/QuanLyChiTieu/fontawesome-free-6.5.1-web/css/solid.css">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link
	href="https://fonts.googleapis.com/css2?family=Abril+Fatface&family=Madimi+One&family=Neuton:ital,wght@0,200;0,300;0,400;0,700;0,800;1,400&display=swap"
	rel="stylesheet">
</head>
...
if (img == "")
	img = "/QuanLyChiTieu/img/default_avatar.png";
...
<body>
	<div class="left1">
		...
		<div class="logo">
			<img src="/QuanLyChiTieu/img/logo.png" alt=""
		...
		<div class="tags">
			...
			<div class="log_out">
				<i class="fa-solid fa-right-from-bracket"></i> <span class="link">Log
					out</span>
			</div>
		</div>
	</div>
	<div class="right1">
				...
				<div class="notify">
					...
					<div class="notify-container">
						...
						<div class="notify-item">
							...
							<div class="text">
								<span class="content"><%=name%> mentioned you in a
									comment</span> <span class="date"><%=date123%></span>
							</div>
						</div>
						<%
						}
					...
					<div class="notify-badge">
						...
						if (size_of_notify > 99)
							notify_number = "99+";
						else
							notify_number = size_of_notify + "";
						%>
			...
			<div class="left">
				...
				<div class="chart">
					...
					<div class="row_column">
						<i id="arrow-up" class="fa-solid fa-arrow-up"></i> <i
							id="arrow-right" class="fa-solid fa-arrow-right"></i>
						<div class="mon day">
			...
			<div class="right">
				<div class="activity">
					...
					<div class="item">
						<div class="left">
							<img style="height: 30px;"
								src="/QuanLyChiTieu/img/icon_activity/Eating.png" alt="">
							<p>Eating</p>
						</div>
						<div class="right">
							<%
					...
					<div class="item">
						<div class="left">
							<img style="height: 30px;"
								src="/QuanLyChiTieu/img/icon_activity/Shopping.png" alt="">
							<p>Shopping</p>
						</div>
						<div class="right">
							<%
					...
					<div class="item">
						<div class="left">
							<img style="height: 30px;"
								src="/QuanLyChiTieu/img/icon_activity/Study.png" alt="">
							<p>Study</p>
						</div>
						<div class="right">
							<%
					...
					<div class="item">
						<div class="left">
							<img style="height: 30px;"
								src="/QuanLyChiTieu/img/icon_activity/Moving.png" alt="">
							<p>Moving</p>
						</div>
						<div class="right">
							<%
		...
		<div class="create_first_project"
			style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: flex; flex-direction: column; gap: 50px; justify-content: center;">
			<div class="add_shape"
				style="transform: translateX(50px); cursor: pointer; transition: 0.3s;">
				<div class="row"
					style="height: 20px; width: 80px; background-color: #baddff; position: absolute; border-radius: 10px; box-shadow: 1px 1px 2px 1px gray;"></div>
				<div class="column"
					style="height: 80px; width: 20px; background-color: #baddff; position: absolute; top: -30px; left: 30px; border-radius: 10px; box-shadow: 0px 0px 2px -3px gray;"></div>
			</div>
			<p style="font-size: 20px; font-weight: 500;">Create Your First
				Project.</p>
		</div>
	</div>
	...
	<div class="create_project_box" style="scale: 0;">
		...
		<p id="create_project_successfully"
			style="color: #baddff; display: none; position: absolute; bottom: 70px">Create
			successfully! See it in history.</p>
	...
	<div class="modal user-setting">
		...
		<div class="body">
			...
			<div class="username">
				<span class="name">Username:</span> <input type="text" name="name"
	...
	<script type="text/javascript">
		var user_have_project =
	<%=user_have_project_json%>
		;
		var max_and_current_money =
	<%=max_and_current_money%>
		;
		var week =
	<%=convert_JavaObject_to_Json.convertObjectToJson(week)%>
		var money_in_week =
	<%=convert_JavaObject_to_Json.convertObjectToJson(money_in_week)%>
		var home_tag = document.querySelector("body .left1 .tags .tag .home");
		home_tag.style.backgroundColor = "#F8F9F9";
		var home_point = document
				.querySelector("body .left1 .tags .tag .home .point");
	...
	<script src="/QuanLyChiTieu/home_chi_tieu/logout.js"></script>
	<script src="/QuanLyChiTieu/home_chi_tieu/notify.js"></script>
	<script src="/QuanLyChiTieu/home_chi_tieu/user_setting.js"></script>
</body>
</html>